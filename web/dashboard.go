                ...
                <div class="grid-footer">
                    ...
                    <div class="footer-links">
                        ...
                        <div class="footer-copyright">
                            © ` + buildYear + ` <a href="https://www.zuidwestupdate.nl" target="_blank" rel="noopener noreferrer">Streekomroep ZuidWest</a> • <a href="https://github.com/oszuidwest/zwfm-metadata/blob/main/LICENSE" target="_blank" rel="noopener noreferrer">MIT License</a>
                        </div>
                    </div>
                </div>
            </div>
